...
def get_email():#line:17
        ...
        return f'varytmp+{OO000O0000O0O0O00}uu{OOOO0OOO00O0OO0O0}d@gmail.com'
def p_main(O00O0OOOO0O000000 ,OO000OO00OO00O00O ,OOOOOO000OO00O000 ):#line:22
        OOOOO0OO0000OOOO0 = f'https://pjj.world/{OOOOOO000OO00O000}'
        ...
        print(f'图片已识别:{O00OOOO000O0OO00O}')
        ...
        print(f'验证码已识别：{O0OO00OO0O00OO00O[0]}')
        ...
        if O0O0O0000O0O0O00O.current_url == "https://pjj.world/home":  # line:91
...
def telegram_bot(O0OOOO00O00O0OOO0 ,O000O00OO0OO00000 ):#line:97
        ...
        O0OOOO0OOO0000O00 = requests.post(
            url=f'https://api.telegram.org/bot{OO0O0OOOO0OO00O0O}/sendMessage',
            data=O00O00OO0OO00OO0O,
        )
...
def get_num(O00OO0O0OOOOO000O ):#line:113
        ...
        try:#line:120
                ...
                return re .findall (r'(?<=验证码为 <b>).+(?=</b>，有效)',OO0OO00O0O000OO00 )
...
def get_pos():        #line:171
        ...
        for OO0OOO0O0OO0OO0OO in OOO0O000O0O0OOOOO:
...
def get_track(OOOO0O0OO00O0OO00 ):        #line:196
        ...
        O0OOOOO0OO00OOO0O.extend(-random .randint (2 ,3 ) for _ in range (4 ))
        O0OOOOO0OO00OOO0O.extend(-random .randint (1 ,3 ) for _ in range (4 ))
...
def main():#line:244
        ...
        print(f'剩余点数：{str(O0O0OOO0O00000O00)}')
